...
from pageplus.cli.export import dsv, alto, fulltext, pdf
...
class ExportBridge(CLIBridge):
    ...
    def export_fulltext(self,
        ...
        try:
            return fulltext(files, output_dir, dehyphenate=dehyphenate,
                          ro=ro, ro_mode=ReadingOrderMode(ro_mode), open_folder=open_folder)
        except Exception as e:
