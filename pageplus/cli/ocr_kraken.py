...
if spec := util.find_spec('kraken') is None:
...
elif dotenv_values(get_env_path()).get('PAGEPLUS_OCR_KRAKEN', 'False') == 'False':
    ...
    def activate() -> None:
        ...
        """
        set_key(get_env_path(), 'PAGEPLUS_OCR_KRAKEN', 'True')
    ...
    if import_done:
        ...
        def deactivate() -> None:
            ...
            """
            set_key(get_env_path(), 'PAGEPLUS_OCR_KRAKEN', 'False')
